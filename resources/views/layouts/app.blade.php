    ...
    <div class="super_container">
                    ...
                    <div class="row">
                        <div class="col d-flex flex-row">
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{ asset('admin/frontend') }}/images/phone.png"
                                        alt=""></div>+38 068 005 3570
                            </div>
                            <div class="top_bar_contact_item">
                                <div class="top_bar_icon"><img src="{{ asset('admin/frontend') }}/images/mail.png"
                                        alt=""></div>
                            </div>
                            <div class="top_bar_content ml-auto">
                                ...
                                <div class="top_bar_user">
                                    <div class="user_icon"><img src="{{ asset('admin/frontend') }}/images/user.svg"
                                            alt=""></div>
                                    ...
                                    <div class="header_search_form_container">
                                        <form action="#" class="header_search_form clearfix">
                                            ...
                                            <button type="submit" class="header_search_button trans_300"
                                                value="Submit"><img
                                                    src="{{ asset('admin/frontend') }}/images/search.png"
                                                    alt=""></button>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
                            <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                                <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                                    <div class="wishlist_icon"><img src="{{ asset('admin/frontend') }}/images/heart.png"
                                            alt=""></div>
                            ...
                            <div class="page_menu_content">
                                ...
                                <ul class="page_menu_nav">
                                    ...
                                    <li class="page_menu_item"><a
                                            href="{{ asset('admin/frontend') }}/contact.html">contact<i
                                                class="fa fa-angle-down"></i></a></li>
                                </ul>
        ...
        <div class="banner">
            <div class="banner_background"
                style="background-image:url({{'admin/frontend/'}}images/banner_background.jpg)"></div>
            <div class="container fill_height">
                <div class="row fill_height">
                    <div class="banner_product_image"><img src="{{ asset('admin/frontend') }}/images/banner_product.png"
                            alt=""></div>
                                ...
                                <div class="owl-carousel owl-theme deals_slider">
                                    ...
                                    <div class="owl-item deals_item">
                                        <div class="deals_image"><img
                                                src="{{ asset('admin/frontend') }}/images/deals.png" alt=""></div>
                                    ...
                                    <div class="featured_slider slider">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_1.png"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_2.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Apple
                                                                iPod shuffle</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_3.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Sony
                                                                MDRZX310W</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_4.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price discount">$225<span>$300</span></div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">LUNA
                                                                Smartphone</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_5.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$225</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Canon
                                                                STM Kit...</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_6.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Samsung
                                                                J330F...</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_7.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$379</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Lenovo
                                                                IdeaPad</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="product_image d-flex flex-column align-items-center justify-content-center">
                                                    <img src="{{ asset('admin/frontend') }}/images/featured_8.png"
                                                        alt="">
                                                </div>
                                                <div class="product_content">
                                                    <div class="product_price">$225</div>
                                                    <div class="product_name">
                                                        <div><a href="{{ asset('admin/frontend') }}/product.html">Digitus
                                                                EDNET...</a></div>
                                                    </div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                            ...
                            <div class="owl-carousel owl-theme popular_categories_slider">
                                ...
                                <div class="owl-item">
                                    <div
                                        ...
                                        <div class="popular_category_image"><img
                                                src="{{ asset('admin/frontend') }}/images/popular_1.png" alt="">
                                        </div>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="popular_category d-flex flex-column align-items-center justify-content-center">
                                        <div class="popular_category_image"><img
                                                src="{{ asset('admin/frontend') }}/images/popular_2.png" alt="">
                                        </div>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="popular_category d-flex flex-column align-items-center justify-content-center">
                                        <div class="popular_category_image"><img
                                                src="{{ asset('admin/frontend') }}/images/popular_3.png" alt="">
                                        </div>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="popular_category d-flex flex-column align-items-center justify-content-center">
                                        <div class="popular_category_image"><img
                                                src="{{ asset('admin/frontend') }}/images/popular_4.png" alt="">
                                        </div>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="popular_category d-flex flex-column align-items-center justify-content-center">
                                        <div class="popular_category_image"><img
                                                src="{{ asset('admin/frontend') }}/images/popular_5.png" alt="">
                                        </div>
        ...
        <div class="banner_2">
            <div class="banner_2_background"
                style="background-image:url({{'admin/frontend/'}}images/banner_2_background.jpg)"></div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img
                                                    src="{{ asset('admin/frontend') }}/images/banner_2_product.png"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="arrivals_slider slider">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_1.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$225</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Astro
                                                                    M2 Black</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_2.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$379</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Transcend
                                                                    T.Sonic</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_3.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$379</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Xiaomi
                                                                    Band 2...</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_4.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$225</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Rapoo
                                                                    T8 White</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_5.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$225</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Philips
                                                                    BT6900A</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_6.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$379</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Nokia
                                                                    3310(2017)...</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_7.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$379</div>
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('admin/frontend') }}/images/new_8.jpg"
                                                            alt="">
                                                    </div>
                                                    <div class="product_content">
                                                        <div class="product_price">$225</div>
                                            ...
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div class="product_content">
                                                        <div class="product_price">$225</div>
                                                        <div class="product_name">
                                                            <div><a href="{{ asset('admin/frontend') }}/product.html">Gembird
                                                                    SPK-103</a></div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                    ...
                                    <div class="arrivals_single clearfix">
                                        <div class="d-flex flex-column align-items-center justify-content-center">
                                            <div class="arrivals_single_image"><img
                                                    src="{{ asset('admin/frontend') }}/images/new_single.png" alt="">
                                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 advert_col">
                        ...
                        <div class="advert d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="ml-auto">
                                <div class="advert_image"><img src="{{ asset('admin/frontend') }}/images/adv_1.png"
                                        alt=""></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 advert_col">
                        ...
                        <div class="advert d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="ml-auto">
                                <div class="advert_image"><img src="{{ asset('admin/frontend') }}/images/adv_2.png"
                                        alt=""></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 advert_col">
                        ...
                        <div class="advert d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="ml-auto">
                                <div class="advert_image"><img src="{{ asset('admin/frontend') }}/images/adv_3.png"
                                        alt=""></div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="trends">
            <div class="trends_background"
                style="background-image:url({{'admin/frontend/'}}/images/trends_background.jpg)"></div>
                            ...
                            <div class="owl-carousel owl-theme viewed_slider">
                                ...
                                <div class="owl-item">
                                    <div
                                        ...
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_1.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                                            <div class="viewed_price">$225<span>$300</span></div>
                                            <div class="viewed_name"><a href="#">Beoplay
                                                    H7</a></div>
                                        </div>
                                        <ul class="item_marks">
                                ...
                                <div class="owl-item">
                                    <div
                                        ...
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_2.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                                            <div class="viewed_price">$379</div>
                                            <div class="viewed_name"><a href="#">LUNA
                                                    Smartphone</a></div>
                                        </div>
                                        <ul class="item_marks">
                                            <li class="item_mark item_discount">-25%</li>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_3.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                                            <div class="viewed_price">$225</div>
                                            <div class="viewed_name"><a href="#">Samsung
                                                    J730F...</a></div>
                                        </div>
                                        <ul class="item_marks">
                                            <li class="item_mark item_discount">-25%</li>
                                ...
                                <div class="owl-item">
                                    <div
                                        ...
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_4.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                                            <div class="viewed_price">$379</div>
                                            <div class="viewed_name"><a href="#">Huawei
                                                    MediaPad...</a></div>
                                        </div>
                                        <ul class="item_marks">
                                            <li class="item_mark item_discount">-25%</li>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_5.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                                            <div class="viewed_price">$225<span>$300</span></div>
                                            <div class="viewed_name"><a href="#">Sony PS4
                                                    Slim</a></div>
                                        </div>
                                        <ul class="item_marks">
                                            <li class="item_mark item_discount">-25%</li>
                                ...
                                <div class="owl-item">
                                    <div
                                        class="viewed_item d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="viewed_image"><img
                                                src="{{ asset('admin/frontend') }}/images/view_6.jpg" alt=""></div>
                                        <div class="viewed_content text-center">
                    ...
                    <div class="col">
                        <div
                            ...
                            <div class="newsletter_title_container">
                                <div class="newsletter_icon"><img src="{{ asset('admin/frontend') }}/images/send.png"
                                        alt=""></div>
                        ...
                        <div class="footer_column footer_contact">
                            ...
                            <div class="footer_social">
                                <ul>
                                    ...
                                    <li><a href="#"><i class="fab fa-vimeo-v"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="copyright_content">
                                ...
                                <script>
                                    ...
                                    aria-hidden="true"></i> by <a href="" target="_blank">TemplatesPoint</a>
                            </div>
                            <div class="logos ml-sm-auto">
                                <ul class="logos_list">
                                    <li><a href="#"><img src="{{ asset('admin/frontend') }}/images/logos_1.png"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('admin/frontend') }}/images/logos_2.png"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('admin/frontend') }}/images/logos_3.png"
                                                alt=""></a></li>
                                    <li><a href="#"><img src="{{ asset('admin/frontend') }}/images/logos_4.png"
                                                alt=""></a></li>
                                </ul>
                            </div>
                        </div>
